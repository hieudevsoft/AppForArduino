...
import com.devapp.appforarduino.databinding.ItemCardVisitBinding
import jp.wasabeef.recyclerview.animators.holder.AnimateViewHolder


class InformationAdapter : RecyclerView.Adapter<InformationAdapter.ViewHolder>(){

    inner class ViewHolder(val binding: ItemCardVisitBinding):RecyclerView.ViewHolder(binding.root),AnimateViewHolder {
